...
- 그림, 표, 코드 번호 참조 내용 없이(\@ref...없이) \@label(...)만 사용되면 각각 그림, 표, 코드 번호만 붙임
    ...
    - 참조하는 부분에서 '는', '은', '가', '이', '을', '를', '나', '이나'가 조사로 사용되는 경우 적절한 조사로 변경함
        - 예) \@ref(fig:a1)는 a1이라는 본문에서 처음 나타나는 그림이다. --> 그림 1-1은 a1이라는 본문에서 처음 나타나는 그림이다 (는 --> 은이 자동으로 변경됨)

- 코드에 줄 번호를 붙이고 싶으면, 코드 펜스 기호(\`\`\`) 다음에 \@linenum을 추가하거나 빈 칸으로 두면 됨 (만약 \`\`\` 다음에 언어를 지정하면, 그 뒤에 붙이면 됨)
    - 일반 텍스트 블록(인용문이 아닌 마크다운 문서 내용)에서는 \"```\" 다음에 \@linenum을 붙이지 않아도 자동으로 줄 번호를 붙임
    ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    - 예) 
    \`\`\` python \@linenum
    \`\`\` \@linenum
...
- 줄 번호를 붙이지 않고 싶다면 \`\`\` 다음에 \@nolinenum을 붙임
    ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    - 예)  
    \`\`\` python \@nolinenum
    \`\`\` \@nolinenum
...
- 인용문 내에서 코드에 줄 번호를 붙이고 싶으면 \`\`\` 다음에 \@linunum을 추가해야 함
    ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    - 예)  
    \> \`\`\` python \@linenum
    \> `\`\` \@linenum
...
- 인용문 내에서 \`\`\` 다음에 \@nolinunum이 있거나 아무것도 없으면 줄 번호 추가 안함
    ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    - 예)  
    \> \`\`\` python \@nolinenum
    \> `\`\` \@nolinenum    
